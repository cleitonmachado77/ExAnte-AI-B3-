...
from .cvm_download import download_dfp
from .cvm_load import load_all
...
def run(year: int = 2024, force_download: bool = False) -> pd.DataFrame:
    ...
    cols = [
        "rank", "DENOM_CIA", "setor", "score_0_100", "score_bruto",
        ...
        "exposicao", "exposicao_0_100", "f_fin", "f_fin_0_100",
        "readiness", "readiness_0_100", "mult_setor",
        "rho_captura", "fator_execucao", "obj2_desconto_captura_rs", "obj2_desconto_total_rs",
        "obj3_ajuste_execucao_rs",
        "receita", "sga", "vendas", "pessoal", "cpv", "pdd", "estoques",
        "caixa", "divida_liquida", "ebitda", "ativo_total",
        ...
        "caixa_sobre_ativo", "dl_sobre_ebitda", "valido",
    ]
